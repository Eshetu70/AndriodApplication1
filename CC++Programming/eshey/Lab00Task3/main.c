...
int main(void) {
  ...
  scanf("%d", &x);
  while (x != 1234) {
    printf("x Binary: "); print_bin(x); printf("\n");
    ...
    if (is_negative(x) != (x < 0))
      ...
      printf("PASSED");
    printf(": IS NEGATIVE\n");
    printf("Expected: ");          print_bool((x<0)); printf("\n");
    printf("     Got: "); print_bool(is_negative(x)); printf("\n");
    ...
    printf("Expected: ");               print_bin(a(x)); printf("\n");
    printf("     Got: "); print_bin(twos_complement(x)); printf("\n");
    ...
    if (times_ten((unsigned)x) != x*10)
      ...
      printf("PASSED");
    printf(": TIMES TEN\n");
    printf("Expected: ");           print_bin(x*10); printf(" (%d)\n", x*10);
    printf("     Got: "); print_bin(times_ten(x)); printf(" (%d)\n", times_ten(x));
